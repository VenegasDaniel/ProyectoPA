...
public class EditDataPersonScreen extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					EditDataPersonScreen frame = new EditDataPersonScreen(p,connect);
	 ...
	 * Create the frame.
	 */
	public EditDataPersonScreen(Person p,ConnectionDB connect) {
		EditDataPersonScreen.p = p;
		EditDataPersonScreen.connect = connect;
		...
		buttonFinishEdit.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				ua.setVisible(true);
				EditDataPersonScreen.this.dispose();	
			}	
		});
